...
public class HivePartitionManager
{
            ...
            ConnectorSession session)
    {
        ...
        if (partitionColumns.isEmpty()) {
            ...
            return () -> {
                List<String> partitionNames = partitionFilteringFromMetastoreEnabled ? getFilteredPartitionNames(session, metastore, hiveTableHandle.getSchemaTableName(), effectivePredicate) : getAllPartitionNames(session, metastore, hiveTableHandle.getSchemaTableName(), constraint);
